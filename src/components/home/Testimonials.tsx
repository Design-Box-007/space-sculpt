...
const TestimonialGrid: React.FC<{ testimonials: Testimonial[] }> = ({
  testimonials,
}) => {
  return (
        ...
        <div
          ...
          className={`p-3 rounded-[28px] row-span-1 flex flex-col items-center ${
            index === 0
              ...
              : index === 1
              ? "lg:row-span-1 lg:justify-start"
              : index === 2
              ? "lg:row-span-2 lg:justify-start"
        ...
        >
          ...
          >
            <div className="space-y-4">
              ...
              />
              <p className="text-white text-base md:text-xl lg:text-2xl font-medium italic font-montserrat">
                {item.testimonial}
              </p>
            </div>
            <div className="flex flex-row gap-4 justify-start items-center">
              <h4 className="text-white text-[22px] leading-[29px] font-bold font-montserrat">
                - {item.testimonee}
              </h4>
            </div>
          </motion.div>
    ...
    <section className="px-4 py-20">
      <div className="flex flex-col lg:flex-row gap-4">
        <div className="w-full lg:w-3/4 flex flex-col justify-between">
          ...
          <motion.h3
            className="md:text-4xl text-2xl leading-8 lg:leading-[108px] font-cinzel italic"
            initial={{ opacity: 0, x: -50 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, amount: 0.5 }}
        ...
        <div className="w-full lg:w-1/4 flex items-end font-montserrat text-justify">
          ...
          <motion.p
            ...
            transition={{ duration: 1, delay: 0.3 }}
          >
            Hear from our satisfied clients who turned their spaces into
            stunning works of art with Space Sculpt’s expert touch
          </motion.p>
        </div>
      </div>
